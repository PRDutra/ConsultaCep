...
uses
  UdmConsulta, uFormatoResposta, InterfaceEnderecoRepository, UEnderecoRepositoryImpl;
...
begin
  DmConsulta.LoadData;
  dsEndereco.DataSet := TEnderecoRepository(DmConsulta.EnderecoRepo).DadosEndereco;
end;
...
procedure TfrmPrincipal.LimparCamposConsulta;
begin
  edtCEP.Clear;
